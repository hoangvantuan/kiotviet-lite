...
Giải quyết nợ kỹ thuật tích luỹ từ MVP trước khi deploy production và bắt đầu Phase 2. Chia 3 đợt theo mức ưu tiên: Critical (blocking production), Security Hardening, Performance & Quality.
**TDs:** TD1-TD30
**Stories:** 11.1 (Critical: production blockers), 11.2 (Security Hardening), 11.3 (Performance & Quality)
