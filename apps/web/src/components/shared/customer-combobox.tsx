...
export function CustomerCombobox({
  ...
  // If we have a value but it's not in the list, fetch it directly
  const { data: detailData } = useCustomerQuery(
    value && !customers.find((c) => c.id === value) ? value : undefined,
  )
  const selectedCustomer = customers.find((c) => c.id === value) ?? detailData
