...
export function PaymentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md max-h-[95vh] flex flex-col p-4 sm:p-6 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto space-y-4 min-h-0 -mx-1 px-1">
          {/* Grand total */}
