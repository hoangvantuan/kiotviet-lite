...
- Cơ sở dữ liệu vừa nạp lại dữ liệu mẫu (`db:seed`). Tồn ban đầu dùng ở bước 7.4: Mì Hảo Hảo `MH001` 300 gói, Nước tương Maggi `MG001` 50 chai, Sting Dâu `ST001-DAU` 50 chai.
...
| 3    | Bấm nút "Thanh toán (F2)", chọn hình thức "Tiền mặt".                                                                         | Tiền khách đưa: `50.000 đ`                     | Hiển thị "Tiền thừa: 12.000 đ".                                                                                              |                 |         |
| 4    | Bấm nút "Hoàn thành".                                                                                                         |                                                | Đơn hàng hoàn tất ngay lập tức (không bị treo chờ máy chủ), mang mã tạm thời dạng `TAM-XXXXXXXX`, giỏ hàng làm mới sẵn sàng. |                 |         |
| 5    | Tạo thêm đơn hàng thứ hai: tìm "Sting", chọn biến thể Vị `Dâu` (`ST001-DAU`, 10.000 đ/chai), số lượng 2, thanh toán tiền mặt. | Đơn thứ 2: 20.000 đ                            | Đơn hàng thứ hai tạo thành công ngoại tuyến.                                                                                 |                 |         |
| 6    | Quan sát biểu tượng chỉ báo ngoại tuyến trên thanh tiêu đề.                                                                   |                                                | Xuất hiện huy hiệu số màu xanh (badge) hiển thị số `2` (báo hiệu có 2 đơn hàng đang chờ đồng bộ lên máy chủ).                |                 |         |
